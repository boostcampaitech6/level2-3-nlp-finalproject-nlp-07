...
ANTICIPATION_MODEL_NAME = config['ANTICIPATION_MODEL_NAME'] # slower inference, better sample quality
...
create_folder_if_not_exists(os.path.join(LOGS_DIR, "generate"))
