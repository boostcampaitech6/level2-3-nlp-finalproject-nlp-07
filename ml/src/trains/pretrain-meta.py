...
def main():
    ...
    fine_tune_data_path = project_path+'/data/full/lakh_clean_midi'
    metas = pd.read_csv(project_path+'/data/meta/lakh_clean_midi.csv')
    ...
    output_path = project_path+f"/models/pretrain/{datetime.now().strftime('%Y%m%d-%H%M%S')}"
